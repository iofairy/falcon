...
public class DateTimeTest {
    ...
    @Test
    public void testOf() {
        DateTime<Date> dateTime01 = DateTime.of(0);
        DateTime<Date> dateTime02 = DateTime.of(1710076101113L);
        DateTime<Date> dateTime03 = DateTime.ofEpochSecond(0);
        DateTime<Date> dateTime04 = DateTime.ofEpochSecond(1710076101L);
        DateTime<ZonedDateTime> dateTime05 = DateTime.of(1970, 1, 1, 0, 0, 0, 26, TZ.UTC);
        DateTime<ZonedDateTime> dateTime06 = DateTime.of(1970, 1, 1, 8, 0, 0, 26, null);
        DateTime<ZonedDateTime> dateTime07 = DateTime.of(2024, 3, 10, 13, 8, 21, 0, TZ.UTC);
        DateTime<ZonedDateTime> dateTime08 = DateTime.of(2024, 3, 10, 21, 8, TZ.DEFAULT_ZONE);
        DateTime<ZonedDateTime> dateTime09 = DateTime.of(-805, 3, 10, 21, 8, 0, 26, TZ.DEFAULT_ZONE);
    ...
    public void testDTPlusAndMinus() {
        ...
        DateTime<Calendar> dt08 = dt6.plusWeeks(-2);
        DateTime<Date> dt09 = dt7.minusWeeks(-3);
    ...
    public void testParse() {
        ...
        DateTime<LocalDateTime> dt5 = DateTime.parse("9/22/2024", "M/d/y");
        DateTime<LocalDateTime> dt6 = DateTime.parse("9/22/2024 9", "M/d/y H");
        ...
        DateTime<Date> dt05 = DateTime.parseDate("9/22/2024", "M/d/y");
        DateTime<Date> dt06 = DateTime.parseDate("9/22/2024 23", "M/d/y H");
        ...
        assertEquals(dt5.dtDetail(), "2024-09-22 00:00:00.000000000 [周日]");
        assertEquals(dt6.dtDetail(), "2024-09-22 09:00:00.000000000 [周日]");
    ...
    public void testParseAuto() {
        ...
        DateTime<LocalDateTime> dt0 = DateTime.parse("2022-8-01 10:5:15");  // 2022-08-01 10:05:15.000000000 [周一]
        DateTime<LocalDateTime> dt1 = DateTime.parse("2022-8-01T10:5:15");  // 2022-08-01 10:05:15.000000000 [周一]
        DateTime<LocalDateTime> dt2 = DateTime.parse("2022-8-01T10:5:15.987");  // 2022-08-01 10:05:15.987000000 [周一]
        DateTime<LocalDateTime> dt3 = DateTime.parse("2022");   // 2022-01-01 00:00:00.000000000 [周六]
        DateTime<LocalDateTime> dt4 = DateTime.parse("999");    // 0999-01-01 00:00:00.000000000 [周二]
        DateTime<LocalDateTime> dt5 = DateTime.parse("10点5分");  // 1970-01-01 10:05:00.000000000 [周四]
        DateTime<LocalDateTime> dt6 = DateTime.parse("2022-8-01T10:5:15.98");   // 2022-08-01 10:05:15.980000000 [周一]
        DateTime<LocalDateTime> dt7 = DateTime.parse("202208"); // 2022-08-01 00:00:00.000000000 [周一]
        DateTime<LocalDateTime> dt8 = DateTime.parse("20220810");   // 2022-08-10 00:00:00.000000000 [周三]
        DateTime<LocalDateTime> dt9 = DateTime.parse("2022081017"); // 2022-08-10 17:00:00.000000000 [周三]
        DateTime<LocalDateTime> dt10 = DateTime.parse("202208101706");  // 2022-08-10 17:06:00.000000000 [周三]
        DateTime<LocalDateTime> dt11 = DateTime.parse("20220810170650");    // 2022-08-10 17:06:50.000000000 [周三]
        DateTime<LocalDateTime> dt12 = DateTime.parse("20220810170650666"); // 2022-08-10 17:06:50.666000000 [周三]
        DateTime<LocalDateTime> dt13 = DateTime.parse("20220810T170650666"); // 2022-08-10 17:06:50.666000000 [周三]
        DateTime<LocalDateTime> dt14 = DateTime.parse("2点5分10秒98毫秒");       // 1970-01-01 02:05:10.098000000 [周四]
        DateTime<LocalDateTime> dt15 = DateTime.parse("120220810170650666", "yyyyyMMddHHmmssSSS");  // 12022-08-10 17:06:50.666000000 [周三]
        DateTime<LocalDateTime> dt16 = DateTime.parse("5分10秒8毫秒");           // 1970-01-01 00:05:10.008000000 [周四]
        DateTime<LocalDateTime> dt17 = DateTime.parse("5分10秒98毫秒");          // 1970-01-01 00:05:10.098000000 [周四]
        DateTime<LocalDateTime> ldt01 = DateTime.parse("999/01/2T6:16:6.6Z");   // 999-01-02 06:16:06.600000000 [周三]
        DateTime<LocalDateTime> ldt02 = DateTime.parse("2020-01-2T6:16:6.65Z");     // 2020-01-02 06:16:06.650000000 [周四]
        DateTime<LocalDateTime> ldt03 = DateTime.parse("2020.01.2T6:16:6.036Z");    // 2020-01-02 06:16:06.036000000 [周四]

        DateTime<Date> dt00 = DateTime.parseDate("2022-8-01 10:5:15", TZ.UTC);  // 2022-08-01 18:05:15.000000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<Date> dt01 = DateTime.parseDate("2022-8-01T10:5:15");  // 2022-08-01 10:05:15.000000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<Date> dt02 = DateTime.parseDate("2022-8-01T10:5:15.987");  // 2022-08-01 10:05:15.987000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<Date> dt03 = DateTime.parseDate("2022");   // 2022-01-01 00:00:00.000000000 [Asia/Shanghai +08:00 GMT+8 周六]
        DateTime<Date> dt04 = DateTime.parseDate("999");    // 0999-01-01 00:00:00.000000000 [Asia/Shanghai +08:05 GMT+8:05:43 周二]
        DateTime<Date> dt05 = DateTime.parseDate("2点5分", TZ.NEW_YORK);  // 1970-01-01 15:05:00.000000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt06 = DateTime.parseDate("2022-8-01T10:5:15.98");   // 2022-08-01 10:05:15.980000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<Date> dt07 = DateTime.parseDate("20220810T170650666");     // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<Date> dt08 = DateTime.parseDate("20220810170650666"); // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<Date> dt20 = DateTime.parseDate("2点5分10秒98毫秒");        // 1970-01-01 02:05:10.098000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt21 = DateTime.parseDate("2点5分10秒098毫秒");       // 1970-01-01 02:05:10.098000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt22 = DateTime.parseDate("2023年10月1日2点5分10秒1毫秒");   // 2023-10-01 02:05:10.001000000 [Asia/Shanghai +08:00 GMT+8 周日]
        DateTime<Date> dt23 = DateTime.parseDate("2023年10月1日2时5分10秒100毫秒"); // 2023-10-01 02:05:10.100000000 [Asia/Shanghai +08:00 GMT+8 周日]
        DateTime<Date> dt24 = DateTime.parseDate("020220810170650666", "yyyyyMMddHHmmssSSS");   // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<Date> dt25 = DateTime.parseDate("5分10秒8毫秒");            // 1970-01-01 00:05:10.008000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt26 = DateTime.parseDate("5分10秒98毫秒");           // 1970-01-01 00:05:10.098000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt27 = DateTime.parseDate("5分10秒");                 // 1970-01-01 00:05:10.000000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt28 = DateTime.parseDate("999/01/2T6:16:6.6Z");     // 999-01-02 14:21:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]
        DateTime<Date> dt29 = DateTime.parseDate("2020-01-2T6:16:6.65Z");   // 2020-01-02 14:16:06.650000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt30 = DateTime.parseDate("2020.01.2T6:16:6.036Z");  // 2020-01-02 14:16:06.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt31 = DateTime.of("999/01/2T6:16:6.6Z");         // 999-01-02 14:21:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]
        DateTime<Date> dt32 = DateTime.of("2020-01-2T6:16:6.65Z");      // 2020-01-02 14:16:06.650000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt33 = DateTime.of("2020.01.2T6:16:6.036Z");     // 2020-01-02 14:16:06.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt34 = DateTime.parseDate("999-1-2 6:6:6 [GMT+04:00 +04:00]");       // 999-01-02 10:11:49.000000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]
        DateTime<Date> dt35 = DateTime.parseDate("999/1/2 6:6:6.6 [Asia/Shanghai +08:00]"); // 999-01-02 06:11:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]
        DateTime<Date> dt36 = DateTime.parseDate("2025-01-02 06:16:26.036 [Asia/Shanghai +08:00]"); // 2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt37 = DateTime.parseDate("999-1-2 6:6:6 [+04:00]");         // 999-01-02 10:11:49.000000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]
        DateTime<Date> dt38 = DateTime.parseDate("999.1.2 6:6:6.6 [+08:00]");       // 999-01-02 06:11:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]
        DateTime<Date> dt39 = DateTime.parseDate("2025-01-02 06:16:26.036 [+08:00]");           // 2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt40 = DateTime.parseDate("2025.01.02 06:16:26.036 [+08:00]");           // 2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt41 = DateTime.parseDate("2025/01/02 06:16:26.036 [+08:00 +08:00]");    // 2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<Date> dt42 = DateTime.parseDate("2025.01.02 06:16:26.036 [GMT+04:00 +04:00]"); // 2025-01-02 10:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]

        DateTime<ZonedDateTime> dt50 = DateTime.parseZDT("2022-8-01 10:5:15");              // 2022-08-01 10:05:15.000000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<ZonedDateTime> dt51 = DateTime.parseZDT("2022-8-01T10:5:15");              // 2022-08-01 10:05:15.000000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<ZonedDateTime> dt52 = DateTime.parseZDT("2022-8-01T10:5:15.987");              // 2022-08-01 10:05:15.987000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<ZonedDateTime> dt53 = DateTime.parseZDT("2022");               // 2022-01-01 00:00:00.000000000 [Asia/Shanghai +08:00 GMT+8 周六]
        DateTime<ZonedDateTime> dt54 = DateTime.parseZDT("999");                // 999-01-01 00:00:00.000000000 [Asia/Shanghai +08:05 GMT+8:05:43 周二]
        DateTime<ZonedDateTime> dt55 = DateTime.parseZDT("2点5分");               // 1970-01-01 02:05:00.000000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt56 = DateTime.parseZDT("2022-8-01T10:5:15.98");               // 2022-08-01 10:05:15.980000000 [Asia/Shanghai +08:00 GMT+8 周一]
        DateTime<ZonedDateTime> dt57 = DateTime.parseZDT("20220810T170650666");             // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<ZonedDateTime> dt58 = DateTime.parseZDT("20220810170650666");              // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<ZonedDateTime> dt59 = DateTime.parseZDT("2点5分10秒98毫秒");                // 1970-01-01 02:05:10.098000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt60 = DateTime.parseZDT("2点5分10秒098毫秒");               // 1970-01-01 02:05:10.098000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt61 = DateTime.parseZDT("2023年10月1日2点5分10秒1毫秒");               // 2023-10-01 02:05:10.001000000 [Asia/Shanghai +08:00 GMT+8 周日]
        DateTime<ZonedDateTime> dt62 = DateTime.parseZDT("2023年10月1日2时5分10秒100毫秒");             // 2023-10-01 02:05:10.100000000 [Asia/Shanghai +08:00 GMT+8 周日]
        DateTime<ZonedDateTime> dt63 = DateTime.parseZDT("020220810170650666", "yyyyyMMddHHmmssSSS");   // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<ZonedDateTime> dt64 = DateTime.parseZDT("5分10秒8毫秒");               // 1970-01-01 00:05:10.008000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt65 = DateTime.parseZDT("5分10秒98毫秒");              // 1970-01-01 00:05:10.098000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt66 = DateTime.parseZDT("5分10秒");              // 1970-01-01 00:05:10.000000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt67 = DateTime.parseZDT("999/01/2T6:16:6.6Z");             // 999-01-02 06:16:06.600000000 [Z +00:00 GMT 周三]
        DateTime<ZonedDateTime> dt68 = DateTime.parseZDT("2020-01-2T6:16:6.65Z");               // 2020-01-02 06:16:06.650000000 [Z +00:00 GMT 周四]
        DateTime<ZonedDateTime> dt69 = DateTime.parseZDT("2020.01.2T6:16:6.036Z");              // 2020-01-02 06:16:06.036000000 [Z +00:00 GMT 周四]
        DateTime<ZonedDateTime> dt70 = DateTime.parseZDT("2023年10月1日2点5分10秒1毫秒", TZ.DUBAI);
        DateTime<ZonedDateTime> dt71 = DateTime.parseZDT("2020-01-2T6:16:6.65Z", TZ.DUBAI);
        ...
        System.out.println("============================================================");
        DateTime<ZonedDateTime> dt72 = DateTime.parseZDT(date1, dtf);                   // 2025-01-02 06:16:06.036000000 [Z +00:00 GMT 周四]
        DateTime<ZonedDateTime> dt73 = DateTime.parseZDT(date2, dtf);                   // 2025-01-02 06:16:06.036000000 [Asia/Dubai +04:00 GMT+4 周四]
        DateTime<ZonedDateTime> dt74 = DateTime.parseZDT(date3, dtf);                   // 2025-01-02 06:16:06.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt75 = DateTime.parseZDT(date1, dtfWithZone);           // 2025-01-02 06:16:06.036000000 [Z +00:00 GMT 周四]
        DateTime<ZonedDateTime> dt76 = DateTime.parseZDT(date2, dtfWithZone);           // 2025-01-02 06:16:06.036000000 [Asia/Dubai +04:00 GMT+4 周四]
        DateTime<ZonedDateTime> dt77 = DateTime.parseZDT(date3, dtfWithZone);           // 2025-01-02 06:16:06.036000000 [Asia/Shanghai +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt78 = DateTime.parseZDT(date4, offsetDtf);             // 2025-01-02 06:16:06.036000000 [Z +00:00 GMT 周四]
        DateTime<ZonedDateTime> dt79 = DateTime.parseZDT(date5, offsetDtf);             // 2025-01-02 06:16:06.036000000 [+04:00 +04:00 GMT+4 周四]
        DateTime<ZonedDateTime> dt80 = DateTime.parseZDT(date6, offsetDtf);             // 2025-01-02 06:16:06.036000000 [+08:00 +08:00 GMT+8 周四]
        DateTime<ZonedDateTime> dt81 = DateTime.parseZDT(date4, offsetDtfWithZone);     // 2025-01-02 10:16:06.036000000 [GMT+04:00 +04:00 GMT+4 周四]
        DateTime<ZonedDateTime> dt82 = DateTime.parseZDT(date5, offsetDtfWithZone);     // 2025-01-02 06:16:06.036000000 [GMT+04:00 +04:00 GMT+4 周四]
        DateTime<ZonedDateTime> dt83 = DateTime.parseZDT(date6, offsetDtfWithZone);     // 2025-01-02 02:16:06.036000000 [GMT+04:00 +04:00 GMT+4 周四]

        DateTime<ZonedDateTime> dt84 = DateTime.parseZDT("999-1-2 6:6:6 [GMT+04:00 +04:00]");
        DateTime<ZonedDateTime> dt85 = DateTime.parseZDT("999/1/2 6:6:6.6 [Asia/Shanghai +08:00]");
        DateTime<ZonedDateTime> dt86 = DateTime.parseZDT("2025-01-02 06:16:26.036 [Asia/Shanghai +08:00]");
        DateTime<ZonedDateTime> dt87 = DateTime.parseZDT("999-1-2 6:6:6 [+04:00]");
        DateTime<ZonedDateTime> dt88 = DateTime.parseZDT("999.1.2 6:6:6.6 [+08:00]");
        DateTime<ZonedDateTime> dt89 = DateTime.parseZDT("2025-01-02 06:16:26.036 [+08:00]");
        DateTime<ZonedDateTime> dt90 = DateTime.parseZDT("2025.01.02 06:16:26.036 [+08:00]");
        DateTime<ZonedDateTime> dt91 = DateTime.parseZDT("2025/01/02 06:16:26.036 [+08:00 +08:00]");
        DateTime<ZonedDateTime> dt92 = DateTime.parseZDT("2025.01.02 06:16:26.036 [GMT+04:00 +04:00]");
        ...
        System.out.println(dt13.dtDetail());        // 2022-08-10 17:06:50.666000000 [周三]
        System.out.println(dt14.dtDetail());
        System.out.println(dt15.dtDetail());
        System.out.println(dt16.dtDetail());
        System.out.println(dt17.dtDetail());
        System.out.println(ldt01.dtDetail());
        System.out.println(ldt02.dtDetail());
        System.out.println(ldt03.dtDetail());
        System.out.println("============================================================================");
        System.out.println(dt00.dtDetail());        // 2022-08-01 18:05:15.000000000 [Asia/Shanghai +08:00 GMT+8 周一]
        ...
        System.out.println(dt08.dtDetail());        // 2022-08-10 17:06:50.666000000 [Asia/Shanghai +08:00 GMT+8 周三]
        System.out.println(dt20.dtDetail());
        ...
        System.out.println(dt33.dtDetail());
        System.out.println(dt34.dtDetail());
        System.out.println(dt35.dtDetail());
        System.out.println(dt36.dtDetail());
        System.out.println(dt37.dtDetail());
        System.out.println(dt38.dtDetail());
        System.out.println(dt39.dtDetail());
        System.out.println(dt40.dtDetail());
        System.out.println(dt41.dtDetail());
        System.out.println(dt42.dtDetail());
        System.out.println("============================================================================");
        System.out.println(dt50.dtDetail());
        System.out.println(dt51.dtDetail());
        System.out.println(dt52.dtDetail());
        System.out.println(dt53.dtDetail());
        System.out.println(dt54.dtDetail());
        System.out.println(dt55.dtDetail());
        System.out.println(dt56.dtDetail());
        System.out.println(dt57.dtDetail());
        System.out.println(dt58.dtDetail());
        System.out.println(dt59.dtDetail());
        System.out.println(dt60.dtDetail());
        System.out.println(dt61.dtDetail());
        System.out.println(dt62.dtDetail());
        System.out.println(dt63.dtDetail());
        System.out.println(dt64.dtDetail());
        System.out.println(dt65.dtDetail());
        System.out.println(dt66.dtDetail());
        System.out.println(dt67.dtDetail());
        System.out.println(dt68.dtDetail());
        System.out.println(dt69.dtDetail());
        System.out.println(dt70.dtDetail());
        System.out.println(dt71.dtDetail());
        System.out.println("============================================================");
        System.out.println(dt72.dtDetail());
        System.out.println(dt73.dtDetail());
        System.out.println(dt74.dtDetail());
        System.out.println(dt75.dtDetail());
        System.out.println(dt76.dtDetail());
        System.out.println(dt77.dtDetail());
        System.out.println(dt78.dtDetail());
        System.out.println(dt79.dtDetail());
        System.out.println(dt80.dtDetail());
        System.out.println(dt81.dtDetail());
        System.out.println(dt82.dtDetail());
        System.out.println(dt83.dtDetail());
        System.out.println("============================================================");
        System.out.println(dt84.dtDetail());
        System.out.println(dt85.dtDetail());
        System.out.println(dt86.dtDetail());
        System.out.println(dt87.dtDetail());
        System.out.println(dt88.dtDetail());
        System.out.println(dt89.dtDetail());
        System.out.println(dt90.dtDetail());
        System.out.println(dt91.dtDetail());
        System.out.println(dt92.dtDetail());
        ...
        assertEquals(dt2.dtDetail(), "2022-08-01 10:05:15.987000000 [周一]");
        assertEquals(dt3.dtDetail(), "2022-01-01 00:00:00.000000000 [周六]");
        assertEquals(dt4.dtDetail(), "999-01-01 00:00:00.000000000 [周二]");
        ...
        assertEquals(dt13.dtDetail(), "2022-08-10 17:06:50.666000000 [周三]");
        assertEquals(dt14.dtDetail(), "1970-01-01 02:05:10.098000000 [周四]");
        assertEquals(dt15.dtDetail(), "12022-08-10 17:06:50.666000000 [周三]");
        assertEquals(dt16.dtDetail(), "1970-01-01 00:05:10.008000000 [周四]");
        assertEquals(dt17.dtDetail(), "1970-01-01 00:05:10.098000000 [周四]");
        assertEquals(ldt01.dtDetail(), "999-01-02 06:16:06.600000000 [周三]");
        assertEquals(ldt02.dtDetail(), "2020-01-02 06:16:06.650000000 [周四]");
        assertEquals(ldt03.dtDetail(), "2020-01-02 06:16:06.036000000 [周四]");
        ...
        assertEquals(dt28.dtDetail(), "999-01-02 14:21:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]");
        assertEquals(dt29.dtDetail(), "2020-01-02 14:16:06.650000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt30.dtDetail(), "2020-01-02 14:16:06.036000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt31.dtDetail(), "999-01-02 14:21:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]");
        assertEquals(dt32.dtDetail(), "2020-01-02 14:16:06.650000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt33.dtDetail(), "2020-01-02 14:16:06.036000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt34.dtDetail(), "999-01-02 10:11:49.000000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]");
        ...
        assertEquals(dt37.dtDetail(), "999-01-02 10:11:49.000000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]");
        assertEquals(dt38.dtDetail(), "999-01-02 06:11:49.600000000 [Asia/Shanghai +08:05 GMT+8:05:43 周三]");
        assertEquals(dt39.dtDetail(), "2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt40.dtDetail(), "2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt41.dtDetail(), "2025-01-02 06:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        assertEquals(dt42.dtDetail(), "2025-01-02 10:16:26.036000000 [Asia/Shanghai +08:00 GMT+8 周四]");
        ...
        assertThrows(DateTimeParseException.class, () -> DateTime.parseDate("20228"));
        assertThrows(DateTimeParseException.class, () -> DateTime.parseDate("2022810", TZ.NEW_YORK));
    ...
    public void testWithLocalDateAndTime() {
        ...
        DateTime<LocalDateTime> newDt01 = dt1.withLocalDateTime(localDateTime);     // 2023-11-01 11:03:10.003654789 [周三]
        DateTime<ZonedDateTime> newDt02 = dt2.withLocalDateTime(localDateTime);     // 2023-11-01 11:03:10.003654789 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<ZonedDateTime> newDt03 = dt3.withLocalDateTime(localDateTime);     // 2023-11-01 11:03:10.003654789 [Europe/Moscow +03:00 GMT+3 周三]
        DateTime<Instant> newDt04 = dt4.withLocalDateTime(localDateTime);           // 2023-11-01 11:03:10.003654789 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<OffsetDateTime> newDt05 = dt5.withLocalDateTime(localDateTime);    // 2023-11-01 11:03:10.003654789 [-10:00 GMT-10 周三]
        DateTime<Calendar> newDt06 = dt6.withLocalDateTime(localDateTime);          // 2023-11-01 11:03:10.003000000 [America/New_York -04:00 GMT-4 周三]
        DateTime<Date> newDt07 = dt7.withLocalDateTime(localDateTime);              // 2023-11-01 11:03:10.003000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<LocalDateTime> newDt11 = dt1.withLocalDate(localDate);             // 2023-11-01 08:00:10.000000100 [周三]
        DateTime<ZonedDateTime> newDt12 = dt2.withLocalDate(localDate);             // 2023-11-01 08:00:10.000000100 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<ZonedDateTime> newDt13 = dt3.withLocalDate(localDate);             // 2023-11-01 03:00:10.000000100 [Europe/Moscow +03:00 GMT+3 周三]
        DateTime<Instant> newDt14 = dt4.withLocalDate(localDate);                   // 2023-11-01 08:00:10.000000100 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<OffsetDateTime> newDt15 = dt5.withLocalDate(localDate);            // 2023-11-01 14:00:10.000000100 [-10:00 GMT-10 周三]
        DateTime<Calendar> newDt16 = dt6.withLocalDate(localDate);                  // 2023-11-01 19:00:10.000000000 [America/New_York -04:00 GMT-4 周三]
        DateTime<Date> newDt17 = dt7.withLocalDate(localDate);                      // 2023-11-01 08:00:10.000000000 [Asia/Shanghai +08:00 GMT+8 周三]
        DateTime<LocalDateTime> newDt21 = dt1.withLocalTime(localTime);             // 2022-02-27 11:03:10.003654789 [周日]
        DateTime<ZonedDateTime> newDt22 = dt2.withLocalTime(localTime);             // 2022-02-27 11:03:10.003654789 [Asia/Shanghai +08:00 GMT+8 周日]
        DateTime<ZonedDateTime> newDt23 = dt3.withLocalTime(localTime);             // 2022-02-27 11:03:10.003654789 [Europe/Moscow +03:00 GMT+3 周日]
        DateTime<Instant> newDt24 = dt4.withLocalTime(localTime);                   // 2022-02-27 11:03:10.003654789 [Asia/Shanghai +08:00 GMT+8 周日]
        DateTime<OffsetDateTime> newDt25 = dt5.withLocalTime(localTime);            // 2022-02-26 11:03:10.003654789 [-10:00 GMT-10 周六]
        DateTime<Calendar> newDt26 = dt6.withLocalTime(localTime);                  // 2022-02-26 11:03:10.003000000 [America/New_York -05:00 GMT-5 周六]
        DateTime<Date> newDt27 = dt7.withLocalTime(localTime);                      // 2022-02-27 11:03:10.003000000 [Asia/Shanghai +08:00 GMT+8 周日]
        ...
        assertEquals(newDt01.dtDetail(), "2023-11-01 11:03:10.003654789 [周三]");
        ...
        assertEquals(newDt05.dtDetail(), "2023-11-01 11:03:10.003654789 [-10:00 GMT-10 周三]");
        assertEquals(newDt06.dtDetail(), "2023-11-01 11:03:10.003000000 [America/New_York -04:00 GMT-4 周三]");
        assertEquals(newDt07.dtDetail(), "2023-11-01 11:03:10.003000000 [Asia/Shanghai +08:00 GMT+8 周三]");
        assertEquals(newDt11.dtDetail(), "2023-11-01 08:00:10.000000100 [周三]");
        ...
        assertEquals(newDt15.dtDetail(), "2023-11-01 14:00:10.000000100 [-10:00 GMT-10 周三]");
        ...
        assertEquals(newDt21.dtDetail(), "2022-02-27 11:03:10.003654789 [周日]");
        ...
        assertEquals(newDt25.dtDetail(), "2022-02-26 11:03:10.003654789 [-10:00 GMT-10 周六]");
        assertEquals(newDt26.dtDetail(), "2022-02-26 11:03:10.003000000 [America/New_York -05:00 GMT-5 周六]");
        assertEquals(newDt27.dtDetail(), "2022-02-27 11:03:10.003000000 [Asia/Shanghai +08:00 GMT+8 周日]");
